      ...
      <div className="flex-1 h-[240px]">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data} margin={{ top: 20, right: 20, left: -20, bottom: 10 }}>
            ...
            <Line type="monotone" dataKey="WhatsApp" stroke="#00CCA3" strokeWidth={3} dot={false} activeDot={{r: 6, fill: '#00CCA3'}} />
            <Line type="monotone" dataKey="Email" stroke="#0F2F55" strokeWidth={3} dot={false} />
            <Line type="monotone" dataKey="WebChat" stroke="#D9873E" strokeWidth={3} dot={false} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
