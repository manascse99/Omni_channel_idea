...
export default function TeamCard({ name, tag, agents, active, avatars, icon: Icon }) {
  const tagColors = {
  ...
  return (
    <div className="bg-white rounded-[24px] p-8 shadow-sm border border-gray-100 flex flex-col hover:shadow-md transition-shadow">
      ...
      <button className="w-full bg-[#050B1C] hover:bg-black text-white font-bold py-4 rounded-[12px] transition-colors text-[13px]">
        Assign Conversation
      </button>
    </div>
  );
